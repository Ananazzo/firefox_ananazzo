...
user_pref("detoolkit.telemetry.rejected",     true);
...
user_pref("network.trr.uri", "https://dns.quad9.net/dns-query"); // Quad9
...
user_pref("media.navigator.enabled", false); // Disables camera access via WebRTC.
user_pref("media.gstreamer.enabled", false); // Disables GStreamer media playback (if applicable).
user_pref("device.sensors.enabled", false); // Disables all sensors.

user_pref("media.peerconnection.enabled", false); // Disable WebRTC to prevent leaking IP
